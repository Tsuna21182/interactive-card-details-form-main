...
function Card({ cardName, cardNumb, cardMes, cardYear, cardCVC }: CardProps) {
  ...
  return (
    <div className="bg-[url(/images/bg-main-mobile.png)] md:bg-[url(/images/bg-main-desktop.png)] p-5 bg-no-repeat bg-center bg-cover h-60 lg:h-dvw lg:w-sm 3xl:w-xl ">
      ...
      <div className="bg-[url(/images/bg-card-front.png)] bg-no-repeat bg-cover w-70 h-40 mt-[-4.2rem] absolute rounded-lg p-5 flex flex-col gap-3 justify-end md:w-96 md:h-60 md:mt-[-10.5rem] md:left-70 lg:left-15 lg:mt-[10rem] lg:w-lg xxl:top-1 3xl:top-1 3xl:left-62 3xl:w-xl 3xl:h-80">
        <img
          src="/images/card-logo.svg"
          alt="icono logo"
          className="absolute top-5 left-5 w-14 md:left-5 md:top-6 md:w-20"
        />
        <p className="text-lg text-White md:text-2xl lg:text-4xl tracking-[0.1em] font-[Space_Grotesk] min-w-[200px]">
